    ...
    <>
      ...
      <div className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg">Delete file: {file.name}</h3>
      ...
      <div className="flex flex-row border border-black rounded-xl justify-between hover:bg-slate-400 p-2 mr-10 min-w-[200px] group">
        <a
          href={file.url}
          target="_blank"
        >
        ...
        {role===1&&(  <label htmlFor={`my-modal-for-delete-${file.id}`}>
